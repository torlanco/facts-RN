...
const SelectCategoryScreenWrapper = connect(mapStateToProps, mapDispatchToProps)(SelectCategoryScreen);
export { SelectCategoryScreenWrapper as SelectCategoryScreen }